    ...
    <div className="min-w-[240px] rounded-2xl bg-white border border-slate-200 shadow-lg p-2">
      ...
      >
        <svg viewBox="0 0 24 24" className="h-5 w-5 text-slate-500" aria-hidden="true">
          <path fill="currentColor" d="M22 12a10 10 0 1 0-11.6 9.9v-7h-2.1V12h2.1V9.8c0-2.1 1.2-3.3 3.1-3.3.9 0 1.8.1 1.8.1v2h-1c-1 0-1.3.6-1.3 1.2V12h2.2l-.4 2.9h-1.8v7A10 10 0 0 0 22 12Z"/>
        </svg>
        Facebook
      </a>
      ...
      >
        <svg viewBox="0 0 24 24" className="h-5 w-5 text-slate-500" aria-hidden="true">
          <path fill="currentColor" d="M20.4 20.4h-3.5v-5.5c0-1.3 0-3-1.8-3s-2.1 1.4-2.1 2.9v5.6H9.5V9h3.3v1.6h.1c.5-.9 1.7-1.8 3.4-1.8 3.6 0 4.2 2.3 4.2 5.4v6.2ZM5.6 7.4a2 2 0 1 1 0-4 2 2 0 0 1 0 4ZM3.9 20.4h3.5V9H3.9v11.4Z"/>
        </svg>
        LinkedIn
      </a>
      ...
      >
        <svg viewBox="0 0 24 24" className="h-5 w-5 text-slate-500" aria-hidden="true">
          <path fill="currentColor" d="M12 2a10 10 0 1 0 .001 20.001A10 10 0 0 0 12 2Zm0 2a8 8 0 0 1 6.3 3.1c-1 .5-2.2.9-3.6 1.1A4 4 0 0 0 12 6a4 4 0 0 0-2.7 2.2c-1.4-.2-2.6-.6-3.6-1.1A8 8 0 0 1 12 4Zm-8 8c0-.6.1-1.2.2-1.7 1.1.4 2.4.7 3.7.8v.2c0 1.2.4 2.3 1.1 3.2-1 .3-2 .5-3 .6A8 8 0 0 1 4 12Zm8 8a8 8 0 0 1-3.8-1c.9-.2 1.9-.5 2.8-.9.3.2.7.3 1 .3.3 0 .7-.1 1-.3.9.4 1.9.7 2.8.9A8 8 0 0 1 12 20Zm6-6.9c-1-.1-2-.3-3-.6.7-.9 1.1-2 1.1-3.2v-.2c1.3-.1 2.6-.4 3.7-.8.1.5.2 1.1.2 1.7a8 8 0 0 1-2 5.1Z"/>
        </svg>
        Ma page personnelle
      </a>
    </div>
